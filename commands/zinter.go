...
var (
	errZInterNeed2Keys = errors.New("zinter command need at least 2 keys")
)

type ZInterCmd struct {
	NumKeys    int
	Keys       []string
	Weights    []float64
	Aggregate  string
...
func (cmd *ZInterCmd) Build(args CmdArgs) (err error) {
